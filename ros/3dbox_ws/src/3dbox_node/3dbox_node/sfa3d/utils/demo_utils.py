...
def parse_demo_configs():
    ...
    parser.add_argument('--pretrained_path', type=str,
                        default='/home/airl010/1_Thesis/deep-3d-visual-perception/src/heads/SFA3D/checkpoints/fpn_resnet_18/fpn_resnet_18_epoch_300.pth', metavar='PATH',
    ...
    ####################################################################
    configs.root_dir = '/home/airl010/1_Thesis/deep-3d-visual-perception/src/'
    # configs.dataset_dir = os.path.join(configs.root_dir)
    configs.calib_path = os.path.join(configs.root_dir,'calibration', 'calib.txt')
