...
if __name__ == '__main__':
    ...
    # configs.dataset_dir = "/home/airl010/1_Thesis/deep-3d-visual-perception/src/heads/SFA3D/dataset/kitti/demo/"
    ...
    with torch.no_grad():
        for sample_idx in range(len(demo_dataset)):
            ...
            if out_cap is None:
                ...
                out_path = os.path.join(configs.results_dir, '{}lid_cam_detect5.avi'.format(configs.foldername))
